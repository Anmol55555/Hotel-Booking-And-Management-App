// Will give the option to select date and Room Type
// And based on the given date range and room type
// Will do api call, and save the list of available room based on given date range and room type with the help of handleSearchResult 
// This is getting called from the HomePage.jsx
