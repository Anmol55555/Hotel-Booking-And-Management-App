...
const HomePage = () => {
    ...
    const [roomSearchResults, setRoomSearchResults] = useState([]);     // Will store the list of Available rooms based on the given date range and room Type from the date picker in home page
        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="Phoenix Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phoenix-color">Phoenix Hotel</span>
                        </h1><br />
            ...
            {/* Will find the list of availale rooms based on selected date range and room Type and pass it to handleSearchResult  */}
            <RoomSearch handleSearchResult={handleSearchResult} />          
            <RoomResult roomSearchResults={roomSearchResults} />

            <h4><a className="view-rooms-home" href="/rooms">All Rooms</a></h4>

            <h2 className="home-services">Services at <span className="phoenix-color">Phoenix Hotel</span></h2>
